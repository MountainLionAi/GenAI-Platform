...
blueprint_v2.add_route(gptstream.send_stream_chat, "sendStreamChat", methods=["POST"])
# blueprint_v2.add_route(gptstream.send_chat, "sendChat", methods=["POST"])
# blueprint_v2.add_route(gpt_oneshot.send_oneshot_chat, "sendOneshotChat", methods=["POST"])
# blueprint_v2.add_route(gpt_oneshot.send_raw_chat_stream, "sendRawChatStream", methods=["POST"])
blueprint_v2.add_route(gpt_oneshot.send_stylized_request, "sendStylizedRequest", methods=["POST"])
blueprint_v2.add_route(userRate.user_rate, 'userRate', methods=["POST"])
...
blueprint_v2.add_route(assistant_api.get_user_history, "getAssistantHistory", methods=["POST"])


# 用户相关接口
blueprint_v2.add_route(user.login, "userLogin", methods=["POST"])
blueprint_v2.add_route(user.check_login, "checkLogin", methods=["GET"])
blueprint_v2.add_route(user.register, "register", methods=["POST"])
blueprint_v2.add_route(user.login_out, "loginOut", methods=["GET"])
blueprint_v2.add_route(user.send_verify_code, "sendVerifyCode", methods=["POST"])
blueprint_v2.add_route(user.send_verify_code_new, "sendEmailCode", methods=["POST"])
blueprint_v2.add_route(user.get_captcha, "getCaptcha", methods=["GET"])
blueprint_v2.add_route(user.verify_captcha_code, "testVerifyCode", methods=["POST"])
