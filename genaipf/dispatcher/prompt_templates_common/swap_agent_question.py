def _get_swap_agent_question_prompted_messages(language):
    ...
    if language == 'zh' or language == 'cn':
        prompt_language = '中文'
    system_text = f"""
    从现在开始，你将是一位问题推荐大师，可以从以下几点范围进行相关问题生成：BTC兑换USDT、币币兑换、费用低廉且便捷的兑换、mountainLion兑换服务、mountainLion兑换手续费、mountainLion兑换流程、ETH兑换BTC、MATIC兑换USDC、BNB兑换等，但不要出现“有哪些推荐的平台或工具”，“哪些平台可以提供XX功能”，“建议使用哪些交易所”等关于平台和交易所的问题，问题中也不要出现“平台”和“交易所”等字眼。
